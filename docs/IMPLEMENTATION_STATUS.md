...
**Milestone-3 sustainable session construction and allocation slice.** Use the ranked pressure model to place work with daily limits, breaks, consecutive-work limits, splitting and fragmentation policy, while preserving hard constraints and explaining allocation choices. Stability, repair and the scenario/property suite follow before the gate.
